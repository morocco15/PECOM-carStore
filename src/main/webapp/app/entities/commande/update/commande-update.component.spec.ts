...
describe('Commande Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Utilisateur query and add missing value', () => {
      ...
      const acheteur: IUtilisateur = { id: 89234 };
      ...
      const additionalUtilisateurs = [acheteur];
    ...
    it('Should update editForm', () => {
      const commande: ICommande = { id: 456 };
      const acheteur: IUtilisateur = { id: 56964 };
      commande.acheteur = acheteur;
      ...
      expect(comp.utilisateursSharedCollection).toContain(acheteur);
    });
  });
