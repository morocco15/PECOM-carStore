...
class MarqueResourceIT {
    ...
    public static Marque createEntity(EntityManager em) {
        Marque marque = new Marque().marque(DEFAULT_MARQUE);
        return marque;
    }
    ...
    public static Marque createUpdatedEntity(EntityManager em) {
        Marque marque = new Marque().marque(UPDATED_MARQUE);
        return marque;
    }
    ...
    void createMarque() throws Exception {
        ...
        assertThat(testMarque.getMarque()).isEqualTo(DEFAULT_MARQUE);
    }
    ...
    void putNewMarque() throws Exception {
        ...
        updatedMarque.marque(UPDATED_MARQUE);
        ...
        Marque testMarque = marqueList.get(marqueList.size() - 1);
        assertThat(testMarque.getMarque()).isEqualTo(UPDATED_MARQUE);
    }
    ...
    void fullUpdateMarqueWithPatch() throws Exception {
        ...
        partialUpdatedMarque.marque(UPDATED_MARQUE);
