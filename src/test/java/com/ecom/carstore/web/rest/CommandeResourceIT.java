...
class CommandeResourceIT {
    ...
    private static final Livraison DEFAULT_MODE_LIVRAISON = Livraison.RETRAIT;
    private static final Livraison UPDATED_MODE_LIVRAISON = Livraison.LIVRER;
    ...
    public static Commande createEntity(EntityManager em) {
        Commande commande = new Commande().dateCommande(DEFAULT_DATE_COMMANDE).modeLivraison(DEFAULT_MODE_LIVRAISON);
        return commande;
    }
    ...
    public static Commande createUpdatedEntity(EntityManager em) {
        Commande commande = new Commande().dateCommande(UPDATED_DATE_COMMANDE).modeLivraison(UPDATED_MODE_LIVRAISON);
        return commande;
    }
    ...
    void createCommande() throws Exception {
        ...
        assertThat(testCommande.getModeLivraison()).isEqualTo(DEFAULT_MODE_LIVRAISON);
    }
    ...
    void getAllCommandes() throws Exception {
        ...
        restCommandeMockMvc
            ...
            .andExpect(jsonPath("$.[*].modeLivraison").value(hasItem(DEFAULT_MODE_LIVRAISON.toString())));
    }
    ...
    void getCommande() throws Exception {
        ...
        restCommandeMockMvc
            ...
            .andExpect(jsonPath("$.modeLivraison").value(DEFAULT_MODE_LIVRAISON.toString()));
    }
    ...
    void putNewCommande() throws Exception {
        ...
        updatedCommande.dateCommande(UPDATED_DATE_COMMANDE).modeLivraison(UPDATED_MODE_LIVRAISON);
        ...
        assertThat(testCommande.getModeLivraison()).isEqualTo(UPDATED_MODE_LIVRAISON);
    }
    ...
    void fullUpdateCommandeWithPatch() throws Exception {
        ...
        partialUpdatedCommande.dateCommande(UPDATED_DATE_COMMANDE).modeLivraison(UPDATED_MODE_LIVRAISON);
