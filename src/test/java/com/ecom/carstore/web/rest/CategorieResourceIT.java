...
class CategorieResourceIT {
    ...
    public static Categorie createEntity(EntityManager em) {
        Categorie categorie = new Categorie().categorie(DEFAULT_CATEGORIE);
        return categorie;
    }
    ...
    public static Categorie createUpdatedEntity(EntityManager em) {
        Categorie categorie = new Categorie().categorie(UPDATED_CATEGORIE);
        return categorie;
    }
    ...
    void createCategorie() throws Exception {
        ...
        assertThat(testCategorie.getCategorie()).isEqualTo(DEFAULT_CATEGORIE);
    }
    ...
    void putNewCategorie() throws Exception {
        ...
        updatedCategorie.categorie(UPDATED_CATEGORIE);
        ...
        Categorie testCategorie = categorieList.get(categorieList.size() - 1);
        assertThat(testCategorie.getCategorie()).isEqualTo(UPDATED_CATEGORIE);
    }
    ...
    void partialUpdateCategorieWithPatch() throws Exception {
        ...
        partialUpdatedCategorie.categorie(UPDATED_CATEGORIE);
